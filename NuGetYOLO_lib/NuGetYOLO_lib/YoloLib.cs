...
namespace NuGetYOLO
{
    ...
    public class Detection
    {
        ...
        public Detection(FileDownloader fd)
        {
            filedownloader = fd;
            string neuralNetName = "tinyyolov2-8.onnx";
            if (!filedownloader.FileExists(neuralNetName))
                filedownloader.DownloadFile("https://storage.yandexcloud.net/dotnet4/tinyyolov2-8.onnx", neuralNetName);
